...
class ComentsControllerTest < ActionController::TestCase
  ...
  test "should create coment" do
    assert_difference('Coment.count') do
      post :create, coment: { description: @coment.description, livingroom_id: @coment.livingroom_id, name: @coment.name, user_id: @coment.user_id }
    end
  ...
  test "should update coment" do
    patch :update, id: @coment, coment: { description: @coment.description, livingroom_id: @coment.livingroom_id, name: @coment.name, user_id: @coment.user_id }
    assert_redirected_to coment_path(assigns(:coment))
  end
