...
class ReservesControllerTest < ActionController::TestCase
  ...
  test "should create reserf" do
    assert_difference('Reserf.count') do
      post :create, reserf: { date: @reserf.date, description: @reserf.description, name: @reserf.name, user_id: @reserf.user_id }
    end
  ...
  test "should update reserf" do
    patch :update, id: @reserf, reserf: { date: @reserf.date, description: @reserf.description, name: @reserf.name, user_id: @reserf.user_id }
    assert_redirected_to reserf_path(assigns(:reserf))
  end
